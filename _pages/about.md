...
# Jimmyberg's 개발 소개서
<!-- **이 름 : 김지윤**<br> -->
<!-- **생년월일 : 1990년 03월 09일**<br> -->
<!-- **최종 학력 : 수원대학교 정보통신공학과 졸업 (2009.03 ~ 2016.02)**<br> -->

## Back-End 개발자로서,
2016년부터 금융 SI 프로젝트 개발를 시작으로 다양한 서비스의 `Front-End` & `Back-End` 개발 경험으로 하였고, 전체적인 시스템 인프라 구축 및 아키텍처에 대한 관심으로 **Back-End 개발자** 라는 길을 선택하게 되었습니다.<br><br>
...
### Projects
#### 부산 동백택시 신규 서비스 구축 <small>2022.03 ~ 진행중</small>
* 부산 지역화폐 전용 동백택시 별도 서비스 분리 및 신규 서비스에 대한 회원 관련 프로세스 개발
* 기존 회원 가입 프로세스 간소화
* 택시 서비스 회원 체계 수립

#### 부산 지역화폐 코나카드 관리 사이트 구축 <small>2022.03 ~ 진행중</small>
